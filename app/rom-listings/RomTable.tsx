                ...
                pageItems.map((rom, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={tdBase}>
                        <span className="font-bitcell text-[14px] uppercase tracking-[1.5px]"
                      ...
                      <td style={tdBase}>
                        <span className="font-bitcell text-[15px]" style={{ color: '#e0e0e0' }}>
                          {rom.memory}mb
                        </span>
                      </td>
                      ...
                      <td style={tdBase}>
                        <span className="font-bitcell text-[16px] tabular-nums" style={{ color: '#7a8a9e' }}>
                          ${rom.priceUsd.toLocaleString('en-US', { maximumFractionDigits: 0 })}
                        </span>
                      </td>

                      <td style={tdBase}>
                        <span className="font-bitcell text-[16px] tabular-nums" style={{ color: '#02C7D7' }}>
