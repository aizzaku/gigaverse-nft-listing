...
function SortButton({
  ...
  return (
    <button
      onClick={onClick}
      title={tooltip}
      className="flex items-center gap-1 font-bitcell text-[12px] uppercase tracking-[1.5px] transition-colors hover:text-giga-heading"
...
function OpenSeaIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 90 90" fill="currentColor" aria-hidden>
...
function OutputCell({ gigling }: { gigling: GiglingListing }) {
  if (gigling.state === 'EGG') {
    return (
      <span className="font-bitcell text-[13px]" style={{ color: '#3a4a5e' }}>
        —
      </span>
    )
  }
  ...
  return (
    <div className="flex flex-col leading-none gap-[4px]">
      <span className="font-bitcell text-[14px] tabular-nums" style={{ color: '#e0e0e0' }}>
        {rate}x {type}
      </span>
      {split && (
    ...
    <div className="space-y-3">
        ...
        <div className="overflow-x-auto" style={{ minHeight: '480px' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr>
                {/* image */}
                <th style={{ ...thBase, padding: '6px 8px 6px 12px', width: '48px' }} />
                {/* token */}
                    ...
                    >
                      ...
                      <td style={{ ...tdBase, padding: '4px 8px 4px 12px' }}>
                        {gigling.imageUrl ? (
                          ...
                          <div style={{ width: 36, height: 36, backgroundColor: '#0c2030', opacity: 0.5 }} />
                        )}
                      </td>

                      {/* token */}
                      <td style={tdBase}>
                        <span className="font-bitcell text-[15px]" style={{ color: '#7a8a9e' }}>
                          #{gigling.tokenId}
                        </span>
                      </td>
                      ...
                      <td style={tdBase}>
                        {gigling.rarity ? (
                          <span
                            className="font-bitcell text-[14px] uppercase tracking-[1.5px]"
                          ...
                          <span
                            className="font-bitcell text-[13px] uppercase tracking-[1px]"
                            style={{ color: '#e0e0e0' }}
                          >
                      ...
                      {/* price USD */}
                      <td style={tdBase}>
                        <span className="font-bitcell text-[14px] tabular-nums" style={{ color: '#7a8a9e' }}>
                      ...
                      <td style={tdBase}>
                        <a
                          ...
                          className="relative inline-flex items-center gap-1.5 px-2.5 py-1 border-y-[4px] font-bitcell text-[11px] uppercase tracking-[1.5px] transition-opacity hover:opacity-80"
                          style={{
      ...
      {totalPages > 1 && (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="font-bitcell text-[11px] uppercase tracking-[1.5px]"
            style={{ color: '#7a8a9e' }}>
